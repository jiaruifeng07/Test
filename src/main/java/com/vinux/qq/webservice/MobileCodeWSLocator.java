...
public class MobileCodeWSLocator extends org.apache.axis.client.Service implements com.vinux.qq.webservice.MobileCodeWS {
 ...
 */
    ...
    private java.lang.String MobileCodeWSSoap12_address = "http://webservice.webxml.com.cn/WebServices/MobileCodeWS.asmx";
    ...
    public com.vinux.qq.webservice.MobileCodeWSSoap_PortType getMobileCodeWSSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.vinux.qq.webservice.MobileCodeWSSoap_PortType getMobileCodeWSSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.vinux.qq.webservice.MobileCodeWSSoap12Stub _stub = new com.vinux.qq.webservice.MobileCodeWSSoap12Stub(portAddress, this);
    ...
    private java.lang.String MobileCodeWSSoap_address = "http://webservice.webxml.com.cn/WebServices/MobileCodeWS.asmx";
    ...
    public com.vinux.qq.webservice.MobileCodeWSSoap_PortType getMobileCodeWSSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.vinux.qq.webservice.MobileCodeWSSoap_PortType getMobileCodeWSSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.vinux.qq.webservice.MobileCodeWSSoap_BindingStub _stub = new com.vinux.qq.webservice.MobileCodeWSSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.vinux.qq.webservice.MobileCodeWSSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.vinux.qq.webservice.MobileCodeWSSoap12Stub _stub = new com.vinux.qq.webservice.MobileCodeWSSoap12Stub(new java.net.URL(MobileCodeWSSoap12_address), this);
                _stub.setPortName(getMobileCodeWSSoap12WSDDServiceName());
                return _stub;
            }
            if (com.vinux.qq.webservice.MobileCodeWSSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.vinux.qq.webservice.MobileCodeWSSoap_BindingStub _stub = new com.vinux.qq.webservice.MobileCodeWSSoap_BindingStub(new java.net.URL(MobileCodeWSSoap_address), this);
                _stub.setPortName(getMobileCodeWSSoapWSDDServiceName());
                return _stub;
            }
        }
