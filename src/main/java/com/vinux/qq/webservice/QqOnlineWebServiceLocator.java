...
public class QqOnlineWebServiceLocator extends org.apache.axis.client.Service implements com.vinux.qq.webservice.QqOnlineWebService {
 ...
 */
    ...
    private java.lang.String qqOnlineWebServiceSoap12_address = "http://webservice.webxml.com.cn/webservices/qqOnlineWebService.asmx";
    ...
    public com.vinux.qq.webservice.QqOnlineWebServiceSoap_PortType getqqOnlineWebServiceSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.vinux.qq.webservice.QqOnlineWebServiceSoap_PortType getqqOnlineWebServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.vinux.qq.webservice.QqOnlineWebServiceSoap12Stub _stub = new com.vinux.qq.webservice.QqOnlineWebServiceSoap12Stub(portAddress, this);
    ...
    private java.lang.String qqOnlineWebServiceSoap_address = "http://webservice.webxml.com.cn/webservices/qqOnlineWebService.asmx";
    ...
    public com.vinux.qq.webservice.QqOnlineWebServiceSoap_PortType getqqOnlineWebServiceSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.vinux.qq.webservice.QqOnlineWebServiceSoap_PortType getqqOnlineWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.vinux.qq.webservice.QqOnlineWebServiceSoap_BindingStub _stub = new com.vinux.qq.webservice.QqOnlineWebServiceSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.vinux.qq.webservice.QqOnlineWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.vinux.qq.webservice.QqOnlineWebServiceSoap12Stub _stub = new com.vinux.qq.webservice.QqOnlineWebServiceSoap12Stub(new java.net.URL(qqOnlineWebServiceSoap12_address), this);
                _stub.setPortName(getqqOnlineWebServiceSoap12WSDDServiceName());
                return _stub;
            }
            if (com.vinux.qq.webservice.QqOnlineWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.vinux.qq.webservice.QqOnlineWebServiceSoap_BindingStub _stub = new com.vinux.qq.webservice.QqOnlineWebServiceSoap_BindingStub(new java.net.URL(qqOnlineWebServiceSoap_address), this);
                _stub.setPortName(getqqOnlineWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
