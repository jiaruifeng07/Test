...
public class WeatherWSLocator extends org.apache.axis.client.Service implements com.vinux.qq.webservice.WeatherWS {
 ...
 */
    ...
    public com.vinux.qq.webservice.WeatherWSSoap_PortType getWeatherWSSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.vinux.qq.webservice.WeatherWSSoap_PortType getWeatherWSSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.vinux.qq.webservice.WeatherWSSoap12Stub _stub = new com.vinux.qq.webservice.WeatherWSSoap12Stub(portAddress, this);
    ...
    public com.vinux.qq.webservice.WeatherWSSoap_PortType getWeatherWSSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.vinux.qq.webservice.WeatherWSSoap_PortType getWeatherWSSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.vinux.qq.webservice.WeatherWSSoap_BindingStub _stub = new com.vinux.qq.webservice.WeatherWSSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.vinux.qq.webservice.WeatherWSSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.vinux.qq.webservice.WeatherWSSoap12Stub _stub = new com.vinux.qq.webservice.WeatherWSSoap12Stub(new java.net.URL(WeatherWSSoap12_address), this);
                _stub.setPortName(getWeatherWSSoap12WSDDServiceName());
                return _stub;
            }
            if (com.vinux.qq.webservice.WeatherWSSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.vinux.qq.webservice.WeatherWSSoap_BindingStub _stub = new com.vinux.qq.webservice.WeatherWSSoap_BindingStub(new java.net.URL(WeatherWSSoap_address), this);
                _stub.setPortName(getWeatherWSSoapWSDDServiceName());
                return _stub;
            }
        }
